...
class PanopticFPN(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        images = ImageList.from_tensors(images, self.backbone.size_divisibility)   # .tensors is (B, C, H_P, W_P)
        features = self.backbone(images.tensor)   # here, four levels of FPN outputs
