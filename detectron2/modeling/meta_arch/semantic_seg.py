    ...
    def layers(self, features):
        for i, f in enumerate(self.in_features):
            if i == 0:
                ...
                # x = self._modules[f](features[f])
            else:
                # print(f'feature name: {f}')
                # print(f'x shape {x.shape}')
                # temp = self._modules[f](features[f])
                # print(f'scale heads out shape {temp.shape}')
                # x = x + self._modules[f](features[f])
