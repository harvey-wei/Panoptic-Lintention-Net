...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self,
        ...
        self.attention = MultiHeadPPAttention(d_model=in_channels,
                                              num_heads=num_heads,
...
class SemSegHeadMultiHeadPPAP5P4(nn.Module):
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        level_p5 = nn.ModuleDict({
            ...
            "pp_attention": nn.Sequential(MultiHeadAttention(self.conv_dims,
                                                             num_heads=num_heads,
                                                             num_patches=num_patches,
                                                             query_project=query_project,
                                                             patches_project=patches_project,
                                          ...
                                          MultiHeadAttention(self.conv_dims,
                                                             num_heads=num_heads,
                                                             num_patches=num_patches,
                                                             query_project=query_project,
                                                             patches_project=patches_project,
