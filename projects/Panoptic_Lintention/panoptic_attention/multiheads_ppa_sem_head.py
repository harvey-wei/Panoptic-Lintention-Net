...
class SemSegHeadMultiHeadPPA(nn.Module):
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        for in_feature in self.in_features:
            ...
            if head_distance == 0:
                ...
                head_ops["pp_attention"] = MultiHeadAttention(in_channels=self.conv_dims,
                                                              num_heads=num_heads,
                                                              num_patches=num_patches,
                                                              query_project=query_project,
                                                              patches_project=patches_project,
                ...
                for i in range(head_distance):
                    ppa_list.append(MultiHeadAttention(in_channels=self.conv_dims,
                                                       num_heads=num_heads,
                                                       num_patches=num_patches,
                                                       query_project=query_project,
                                                       patches_project=patches_project,
