...
class SemSegHeadSingleHeadPPAP5P4(nn.Module):
    ...
    def layers(self, features: Dict[str, torch.Tensor]):
        ...
        feature_reduce = self._modules['p4']['channel_reduce'](features['p4']).permute(0, 2, 3, 1)

        # feat (N, conv_dim, 1/4, 1.4)
        feat += self._modules['p4']['pp_attention'](feature_reduce).permute(0, 3, 1, 2)
