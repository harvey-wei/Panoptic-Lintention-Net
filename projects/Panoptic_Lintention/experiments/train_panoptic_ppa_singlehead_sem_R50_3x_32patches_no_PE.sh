...
./train_net.py \
--config-file ./configs/COCO/panoptic_ppa_singlehead_sem_R50_3x.yaml \
--num-gpus 4 SOLVER.IMS_PER_BATCH 8 SOLVER.BASE_LR 0.01 \
MODEL.SEM_SEG_HEAD.PPA_NUM_PATCHES 32 \
MODEL.SEM_SEG_HEAD.PPA_POSITION_EMBED False \
OUTPUT_DIR  "./output_panoptic_ppa_single_head_r50_3x_32patches_no_PE"
