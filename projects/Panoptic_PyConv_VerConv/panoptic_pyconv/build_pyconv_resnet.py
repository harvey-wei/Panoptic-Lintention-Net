...
from projects.Panoptic_PyConv.panoptic_pyconv import resnet, pyconvresnet, pyconvhgresnet
from projects.Panoptic_PyConv.pyconv_util.convert_BN import convert_BN
from detectron2.modeling import BACKBONE_REGISTRY


@BACKBONE_REGISTRY.register()
def build_pyconv_resnet(backbone_net, layers, pretrained, backbone_output_stride=8, convert_bn=None):
    ...
    if backbone_net == 'resnet':
        ...
        return layer0, layer1, layer2, layer3, layer4     # 0 denotes the stem, 1-4 corresponds to stage outputs.
