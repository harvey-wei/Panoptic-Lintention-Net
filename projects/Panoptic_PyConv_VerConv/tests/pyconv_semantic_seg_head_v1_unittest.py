...
from projects.Panoptic_PyConv.panoptic_pyconv import SemSegPyConvHeadV1
from detectron2.layers import (
    ShapeSpec,
)


class SemSegPyConvHeadV1Test(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_sem_seg_pyconv_headV1_test_mode(self):
    ...
    def test_sem_seg_pyconv_headV1_train_mode(self):
